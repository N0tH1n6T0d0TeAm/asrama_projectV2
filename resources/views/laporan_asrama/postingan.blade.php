...
<body>
    <label class="posting">
        ...
        <img id="gambar" class="foto_posting" src="{{ asset('postingan/' . $gambar_baru) }}">
    ...
    <div class="konten">
        <form action="/tambah_siswa" method="POST" enctype="multipart/form-data">
            ...
            <textarea name="deskripsi" placeholder="Tambahkan Deskripsi Anda..." name="deskripsi" id=""
                class="form-control" cols="30" rows="10"></textarea><br><br>


            <div class="tag-input">
                <input type="text" id="tag-input-field" class="form-control siswa" placeholder="Tambahkan Nama Siswa"
                    list="siswa-list" autocomplete="off"> <br>
...
<script>
    $(document).ready(function() {
        ...
        function addTag(tagInput) {
            var tag = $('<span class="tag">' + tagInput +
                '<span style="cursor: pointer" class="remove-tag">&times;</span></span>');
